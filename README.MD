...
This installer enables the fast installation of zsh, antigen (with that oh-my-zsh) and other stuff that is required for a great zsh experience.
...
psh installation. Refer to [Contributing](https://github.com/pascal-zarrad/psh/raw/master/.github/PULL_REQUEST_TEMPLATE.md)
