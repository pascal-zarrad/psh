...
echo "To get customization started, we will now install oh-my-zsh..."
...
# First get environment variable built by oh-my-zsh
oh_my_zsh_variable=$(cat ${HOME}/.zshrc | grep "export ZSH=")
...
# Re-add environment variable initialy added by oh-my-zsh
echo "# Path to your oh-my-zsh installation." >> "${HOME}/.zshrc"
echo "${oh_my_zsh_variable}" >> "${HOME}/.zshrc"
